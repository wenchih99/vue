      ...
      <div class="modal-body">
        <div class="container registration-container">
          <div class="input-group mb-3">
            <input id="email" v-model="fgt_mail" v-on:input="check_mail" type="text" class="form-control form-control-mail" placeholder="Email" autofocus>
          ...
          <div class="form-floating mb-3 mt-3">
            <input id="passwd" v-model="fgt_pwd" v-on:input="check_pwd" type="password" placeholder="Password" class="form-control">
          ...
          <div class="form-floating mb-3 mt-3">
            <input id="repasswd" v-model="fgt_repwd" v-on:input="check_ispwdsame" type="password" placeholder="Re-type Password" class="form-control">
...
export default {
  ...
  methods:{
      ...
      check_mail()
      {
        if(this.fgt_mail.length>0){this.mail_isempty=false}
        else{this.mail_isempty=true}

        var tmp = this.fgt_mail.match("^\\w+([-+.]\\w+)*@(qq|gmail|163|88|139|189|aliyun)\\.+(com|net|cn)$")
        if(tmp!==null){this.mail_islegal=true}
        else{this.mail_islegal=false}
      },
      check_pwd()
      {
        var tmp=this.fgt_pwd
      ...
      check_ispwdsame()
      {
        if(this.fgt_pwd===this.fgt_repwd)
        {
        ...
        //console.log(this.fgt_pwd+':'+this.fgt_repwd)
      }
  },
}
</script>
